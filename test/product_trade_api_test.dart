...
void main() {
  ...
  setUpAll(() async {
    ...
    if (loginRes case DbSuccess(data: final session)) {
  ...
  group('Product Ordering API Tests (Verified with Real Data)', () {
    ...
    test('1. productCategoryList: GET /app-api/product/category/list', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/product/category/list failed: ${res.errorOrNull?.message}");
      
      final List data = res.dataOrNull as List;
    ...
    test('2. productCategoryListByIds: GET /app-api/product/category/list-by-ids', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/product/category/list-by-ids failed: ${res.errorOrNull?.message}");
      expect(res.dataOrNull, isNotEmpty);
      expect((res.dataOrNull as List)[0]['name'], "Đồ uống");
    ...
    test('3. productSpuPage: GET /app-api/product/spu/page', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/product/spu/page failed: ${res.errorOrNull?.message}");
      final data = res.dataOrNull as Map;
    ...
    test('4. productSpuGetDetail: GET /app-api/product/spu/get-detail', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/product/spu/get-detail failed: ${res.errorOrNull?.message}");
      final data = res.dataOrNull as Map;
      expect(data['id'], id);
      expect(data['skus'], isNotEmpty, reason: "Sản phẩm phải có danh sách SKUs");
    ...
    test('5. productSpuListByIds: GET /app-api/product/spu/list-by-ids', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/product/spu/list-by-ids failed: ${res.errorOrNull?.message}");
      final data = res.dataOrNull as List;
    ...
    test('6. productCommentPage: GET /app-api/product/comment/page', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/product/comment/page failed: ${res.errorOrNull?.message}");
      debugPrint("productCommentPage Success - Total reviews: ${(res.dataOrNull as Map)['total']}");
    });
    ...
    test('7. orderSettlementProduct: GET /app-api/trade/order/settlement-product', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/trade/order/settlement-product failed: ${res.errorOrNull?.message}");
      final data = res.dataOrNull as List;
      expect(data, isA<List>());
      if (data.isNotEmpty) {
        expect(data[0]['spuId'], id);
        expect(data[0]['skus'], isNotEmpty);
      }
    ...
    test('8. pickUpStoreList: GET /app-api/trade/delivery/pick-up-store/list', () async {
      ...
      expect(res.isSuccess, true, reason: "API /app-api/trade/delivery/pick-up-store/list failed: ${res.errorOrNull?.message}");
      debugPrint("pickUpStoreList Success - Found ${(res.dataOrNull as List).length} stores");
    });
    ...
    test('9. pickUpStoreGet: GET /app-api/trade/delivery/pick-up-store/get', () async {
      ...
      expect(res.isFailure, false, reason: "API /app-api/trade/delivery/pick-up-store/get error: ${res.errorOrNull?.message}");
      debugPrint("pickUpStoreGet Success (Data: ${res.dataOrNull})");
    });
