...
class ChangeMobilePage extends AppCubitStateFulWidget<ChangeMobileInteractor, ChangeMobileState> {
...
class _ChangeMobilePageState extends AppCubitState<ChangeMobilePage, ChangeMobileInteractor, ChangeMobileState> {
  ...
  @override
  String? getTitle() => 'Thay đổi số điện thoại';
