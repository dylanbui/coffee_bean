...
class TopicSelectionPage extends AppCubitStateFulWidget<TopicSelectionInteractor, TopicSelectionState> {
  TopicSelectionPage({super.key, required super.interactor});

  @override
  State<TopicSelectionPage> createState() => _TopicSelectionPageState();
}

class _TopicSelectionPageState extends AppCubitState<TopicSelectionPage, TopicSelectionInteractor, TopicSelectionState> {
  
  @override
  String? getTitle() => "Chủ đề bạn quan tâm";
  ...
  PreferredSizeWidget? getAppBar(BuildContext context) {
    return CoffeeAppBar(
      ...
      hideBackButton: true, // Specific requirement for this page
    );
  }

  @override
  Widget getBody(BuildContext context) {
    return BlocBuilder<TopicSelectionInteractor, TopicSelectionState>(
