      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              TapEffect(
                  onTap: () => {}, child: _buildActionIcon(AppAssets.icons.icShare, item.shareCount.formatCompact())),
              const SizedBox(width: 10),
              TapEffect(
                  onTap: () => {},
                  child: _buildActionIcon(AppAssets.icons.icComment, item.commentCount.formatCompact())),
              const SizedBox(width: 10),
              TapEffect(
                  onTap: () => {}, child: _buildActionIcon(AppAssets.icons.icLike, item.likeCount.formatCompact())),
              const Spacer(),
            ],
          ),
        ],
